...
typedef enum
{
  ...
  TA_INTERNAL_PARALLEL_VEC_ALLOC_FAILED   = 500,
  TA_INTERNAL_PARALLEL_VEC_ADD_MISMATCH   = 501,
  TA_INTERNAL_PARALLEL_VEC_SUB_MISMATCH   = 502,
  TA_INTERNAL_PARALLEL_VEC_MUL_MISMATCH   = 503,
  TA_INTERNAL_PARALLEL_VEC_DIV_MISMATCH   = 504,
  TA_INTERNAL_PARALLEL_VEC_FMA_MISMATCH   = 505,
